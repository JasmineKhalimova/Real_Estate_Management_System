...
function renderForm($ClientID, $PropertyID, $ClientIDResult, $PropertyIDResult, $error)
...
<header class="masthead" role="banner">
    ...
    <h1 class="title">Add To Client Properties</h1>
...
renderForm($ClientID, $PropertyID, $ClientIDResult, $PropertyIDResult, $error);
...
mysqli_query($conn, "INSERT Client_Properties SET ClientID='$ClientID', PropertyID='$PropertyID'")
...

{
    ...
    renderForm('','', $ClientIDResult, $PropertyIDResult, '');

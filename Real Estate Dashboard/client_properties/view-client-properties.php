...
<title>Client Property Records</title>
...
<h1 class="title">Client Properties</h1>
...
echo '<td><a href="edit-client-property.php?id=' . $row['ID'] . '">Edit</a></td>';

echo '<td><a href="delete-client-property.php?id=' . $row['ID'] . '">Delete</a></td>';
...
?>
<a href='new-client-property.php' id="add-button">Add a new record</a>

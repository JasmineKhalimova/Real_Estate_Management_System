...
<h1 class="title">Payment List</h1>
...
$query = "SELECT ID, Payment_Amount, Payment_Date, PropertyID FROM Payment";
...
echo "<tr> <th>ID</th> <th>Payment Amount</th> <th>Payment Date</th> <th>PropertyID</th> </tr>";
...
echo '<td><a href="edit-payment.php?id=' . $row['ID'] . '">Edit</a></td>';

echo '<td><a href="delete-payment.php?id=' . $row['ID'] . '">Delete</a></td>';
...
?>
<a href='new-payment.php' id="add-button">Add a new record</a>

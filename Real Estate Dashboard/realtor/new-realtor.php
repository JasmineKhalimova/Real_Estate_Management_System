...
function renderForm($Name, $Phone, $Address_Name, $Street, $City, $Province,$Country, $Postal_Code, $error)
...
renderForm($Name, $Phone, $Address_Name, $Street, $City, $Province,$Country, $Postal_Code, $error);
...
mysqli_query($conn, "INSERT Realtor SET Name='$Name', Phone='$Phone', AddressID='$last_id', BrokerageID=1")

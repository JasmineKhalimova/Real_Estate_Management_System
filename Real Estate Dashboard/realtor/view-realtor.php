...
<h1 class="title">Realtor List</h1>
...
$query = "SELECT Realtor.ID as ID, Realtor.Name as Name, Phone, Address.Name as aName, Street, City, Province, Country, Postal_Code  FROM  Realtor LEFT JOIN Address on Realtor.AddressID = Address.ID";
...
echo "<tr> <th>ID</th> <th>Name</th> <th>Phone</th> <th>Address Name</th> <th>Steet</th><th>City</th><th>Province</th><th>Country</th><th>Postal Code</th></tr>";
...
echo '<td><a href="edit-realtor.php?id=' . $row['ID'] . '">Edit</a></td>';

echo '<td><a href="delete-realtor.php?id=' . $row['ID'] . '">Delete</a></td>';
...
<a href='new-realtor.php' id="add-button">Add a new record</a>
